...
class BufferFixedAlgoConfig:
    """
    Configuration for BUFFER_FIXED algorithm.
...
class BufferFixedAlgorithm(OptimizationAlgorithm):
    """
    BUFFER_FIXED algorithm.
    ...
    def __init__(self, params: Dict[str, Any] | None = None):
        ...
        params = params or {}
        self.config = BufferFixedAlgoConfig(
