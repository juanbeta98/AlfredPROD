...
labors_inst_static_df.to_csv(f'{data_path}/instances/artif_inst/{instance}/labors_{instance}_static_df.csv',index=False)
labors_inst_dynamic_df.to_csv(f'{data_path}/instances/artif_inst/{instance}/labors_{instance}_dynamic_df.csv',index=False)
